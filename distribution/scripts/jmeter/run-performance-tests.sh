...
declare -A test_scenario7=(
    ...
    [description]="An HTTP/2 (over TLS) client, which sends requests to an HTTPS back-end service and gets HTTPS responses."
    [bal]="h2_h2_passthrough.balx"
    [bal_flags]=""
    [path]="/passthrough"
    [jmx]="http2-post-request.jmx"
...
declare -A test_scenario8=(
    ...
    [description]="An HTTP/2 (over TLS) server, which accepts requests from an HTTPS client and sends HTTPS responses."
    [bal]="h2_h2_passthrough.balx"
    [bal_flags]=""
    [path]="/passthrough"
    [jmx]="http-post-request.jmx"
