...
declare -A test_scenario0=(
    ...
    [bal]="h1c_h1c_passthrough-executable.jar"
    [bal_flags]=""
    [path]="/passthrough"
...
declare -A test_scenario1=(
    ...
    [bal]="h1_h1_passthrough-executable.jar"
    [bal_flags]=""
    [path]="/passthrough"
    [jmx]="http-post-request.jmx"
    [protocol]="https"
...
declare -A test_scenario2=(
    ...
    [bal]="h1c_transformation-executable.jar"
    [bal_flags]=""
    [path]="/transform"
    [jmx]="http-post-request.jmx"
    [protocol]="http"
...
declare -A test_scenario3=(
    ...
    [bal]="h1_transformation-executable.jar"
    [bal_flags]=""
    [path]="/transform"
    [jmx]="http-post-request.jmx"
    [protocol]="https"
...
declare -A test_scenario4=(
    ...
    [bal]="h2_h2_passthrough-executable.jar"
    [bal_flags]=""
    [path]="/passthrough"
...
declare -A test_scenario5=(
    ...
    [bal]="h2_h1_passthrough-executable.jar"
    [bal_flags]=""
    [path]="/passthrough"
    [jmx]="http2-post-request.jmx"
    [protocol]="https"
...
declare -A test_scenario6=(
    ...
    [bal]="h2_h1c_passthrough-executable.jar"
...
declare -A test_scenario9=(
    ...
    [bal]="passthrough-executable.jar"
    [bal_flags]="--observe"
    [path]="/passthrough"
    [jmx]="http-post-request.jmx"
    [protocol]="http"
...
function before_execute_test_scenario() {
    ...
    JMETER_JVM_ARGS="-Xbootclasspath/p:/opt/alpnboot/alpnboot-executable.jar"
