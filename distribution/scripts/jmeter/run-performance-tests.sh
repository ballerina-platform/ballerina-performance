...
declare -A test_scenario0=(
    ...
    [description]="A HTTP Service, which forwards all requests to a HTTP back-end service."
...
declare -A test_scenario1=(
    ...
    [description]="A HTTPS Service, which forwards all requests to a HTTPS back-end service."
...
declare -A test_scenario2=(
    ...
    [description]="A HTTP Service, which transforms JSON requests to XML and then forwards all requests to a HTTP back-end service."
...
declare -A test_scenario3=(
    ...
    [description]="A HTTPS Service, which transforms JSON requests to XML and then forwards all requests to a HTTPS back-end service."
...
declare -A test_scenario4=(
    ...
    [description]="A HTTPS Service exposed over HTTP2 protocol, which forwards all requests to a HTTP2 (HTTPS) back-end service."
...
declare -A test_scenario5=(
    ...
    [description]="A HTTPS Service exposed over HTTP2 protocol, which forwards all requests to a HTTPS back-end service."
